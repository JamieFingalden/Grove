...
enum CommitPromptBuilder {
    ...
    static func build(_ input: Input) -> Result {
        ...
        let text = """
        请只根据下面提供的文本生成一条提交信息草稿，不要读取工作区文件或运行命令。参考最近的人工提交标题，自行推断仓库惯用的格式、语言、措辞和是否使用 scope；不要硬套其他格式。
        ...
        按所提供的 JSON schema 输出：subject 放标题，确有必要时才填写 body。字段内容只写提交信息本身，不要解释，不要使用代码块，不要添加“这是提交信息”之类的开场白。
        """
